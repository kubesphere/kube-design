...
export type ExtendRuleItem = RuleItem & Partial<{
...
export default class FormItem extends React.Component<FormItemProps, FormItemState> {
  ...
  context!: IFormContext & IGroupContext

  static contextType = { ...FormContext, ...GroupContext }
  ...
  handleValueChange = (name: string, onChange: Callback, value: any, ...rest: any) => {
  ...
  handleError = (name: string, onError: Callback, error?: FormItemError, ...rest: any) => {
  ...
  getValue = (name: string, { value: propsValue, defaultValue }: { value: any, defaultValue: any }) => {
